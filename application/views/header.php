...
<head>
    <meta charset="utf-8">
    <title>Air Isi Ulang Sekar Wangi</title>
        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="<?=base_url('')?>" class="text-decoration-none">
                    <h5 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">Air Isi Ulang </span> Sekar Wangi</h5>
                </a>
            </div>
