    ...
    <div class="container-fluid mb-0">
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <a class="btn shadow-none d-flex align-items-center justify-content-between bg-primary text-white w-100" href="<?=base_url('index.php/Admin/order')?>" style="height: 65px; margin-top: -1px; padding: 0 30px;">
                    <h6 class="m-0">Daftar Order</h6>
                </a>
                <a class="btn shadow-none d-flex align-items-center justify-content-between bg-primary text-white w-100" href="<?=base_url('index.php/Admin/report')?>" style="height: 65px; margin-top: -1px; padding: 0 30px;">
                    <h6 class="m-0">Laporan Penjualan</h6>
                </a>
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link"><?php echo $category['name']?></a>
                        </div>
                        <?php endforeach?> 
                    </div>
                </nav>
    ...
    <div class="container-fluid">
        <div class="text-center mb-4">
            ...
            <h3 class="row px-xl-5 pb-3 justify-content-center"><?= validation_errors(); ?></h3>
            <h3 class="row px-xl-5 pb-3 justify-content-center" ><?= $this->session->flashdata('error'); ?></h3>
        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4 " >
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="<?= base_url('index.php/Galon/update/'.$product['id'])?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Edit</a>
                        <a href="<?= base_url('index.php/Galon/Delete/'.$product['id'])?>" class="btn btn-sm text-dark p-0"><i class="fas fa-trash text-primary mr-1"></i>Delete</a>
                    </div>
                </div>
            </div>
            <?php endforeach?>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="category" value="1" required>
                    <label class="form-check-label" for="flexRadioDefault1">
                        Asli
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="category" value="2" required>
                    <label class="form-check-label" for="flexRadioDefault1">
                        Isi Ulang
                    </label>
                </div>
